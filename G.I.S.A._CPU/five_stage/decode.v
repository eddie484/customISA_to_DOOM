module decode (clk, nRESET, instr_in, pc_in, pcplus4_in, icode_out, load_out, dmen_out, dmrw_out, aluop_out, sign_out, mulsel_out, lk_out, valA_out, valB_out, wdata_out, dmsize_out, dmsext_out, setcc_out, cond_out, branch_out, pcplus4_out, rD_out, wben_out, jump_out, wben_W, dst_W, valD_W);

	input clk, nRESET;
	input [31:0] instr_in, pc_in, pcplus4_in;
	input [31:0] valD_W;
	input [3:0] dst_W;
	input wben_W;

	output [31:0] valA_out, valB_out, wdata_out, pcplus4_out;
