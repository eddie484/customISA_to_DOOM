...
int main(int argc, char *argv[]) {
    if (argc == 2 || argc == 3) {
        ...
        if (strcmp(option, "--lex") != 0 && strcmp(option, "--parse") != 0 && strcmp(option, "--semantic") != 0 && strcmp(option, "--tag") != 0 && strcmp(option, "--codegen") != 0 && strcmp(option, "-S") != 0 && strcmp(option, "--keep") != 0 && strcmp(option, "--no-option") != 0) {
        ...
        snprintf(semantic_filename, sizeof(semantic_filename), "%sd_semantic_%s.semanal", file_dir, file_name);
        ...
        // ***** Semantic Analyzing *****
        printf("Start semantic analyzing.\n\n");

        Node * semantic_result;
        semantic_result = semantic_analyzer(parser_result, semantic_filename);
        
        printf("Semantic analyzing is finished.\n");
        ...
        if (strcmp(option, "--keep") != 0) {
            char remove_semantic_file_cmd[1024];
            snprintf(remove_semantic_file_cmd, sizeof(remove_semantic_file_cmd), "rm %s", semantic_filename);
            if (system(remove_semantic_file_cmd) != 0) return 4;
        }
