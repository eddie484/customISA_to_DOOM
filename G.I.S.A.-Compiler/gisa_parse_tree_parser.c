/*
    ...
    <var_declr> ::= <specifier_list> IDENT <assign> ";"
    <assign> ::= "=" <exp> | ε
    ...
    <declr> ::= <func_declr> | <var_declr>
    <var_declr> ::= <specifier_list> IDENT <assign> "PN_SEMI"
    ...
    <label> ::= 0 52
    <declr> ::= <func_declr> | <var_declr>
    <var_declr> ::= <specifier_list> 0 <assign> 9
    <assign> ::= 33 <exp> | ε
...
FIRST(<program>) = {2, 63, 64, 66, 67, 70, 71, ε}
	...
	FIRST(<instr>) = {0, 1, 2, 4, 5, 7, 9, 10, 11, 13, 24, 44, 49, 53, 54, 55, 56, 57, 58, 59, 60, 61, 63, 64, 65, 66, 67, 68, 69, 70, 71}
	FIRST(<content>) = {0, 1, 4, 5, 7, 9, 10, 11, 13, 24, 44, 49, 53, 54, 55, 56, 57, 58, 59, 60, 61, 65, 68, 69}
	FIRST(<else>) = {50, ε}
	FIRST(<label>) = {0}
	FIRST(<declr>) = {2, 63, 64, 66, 67, 70, 71}
	FIRST(<var_declr>) = {2, 63, 64, 66, 67, 70, 71}
	FIRST(<assign>) = {33, ε}
	FIRST(<for_init>) = {0, 1, 2, 5, 9, 10, 11, 13, 24, 44, 63, 64, 65, 66, 67, 68, 69, 70, 71}
	...
	FOLLOW(<program>) = {$}
	FOLLOW(<func_declr>) = {$, 0, 1, 2, 4, 5, 7, 8, 9, 10, 11, 13, 24, 44, 49, 53, 54, 55, 56, 57, 58, 59, 60, 61, 63, 64, 65, 66, 67, 68, 69, 70, 71}
	FOLLOW(<specifier_list>) = {0}
	FOLLOW(<specifier>) = {0, 2, 63, 64, 66, 67, 70, 71}
	...
	FOLLOW(<instr_list>) = {8}
	FOLLOW(<instr>) = {0, 1, 2, 4, 5, 7, 8, 9, 10, 11, 13, 24, 44, 49, 53, 54, 55, 56, 57, 58, 59, 60, 61, 63, 64, 65, 66, 67, 68, 69, 70, 71}
	FOLLOW(<content>) = {0, 1, 2, 4, 5, 7, 8, 9, 10, 11, 13, 24, 44, 49, 50, 53, 54, 55, 56, 57, 58, 59, 60, 61, 63, 64, 65, 66, 67, 68, 69, 70, 71}
	FOLLOW(<else>) = {0, 1, 2, 4, 5, 7, 8, 9, 10, 11, 13, 24, 44, 49, 50, 53, 54, 55, 56, 57, 58, 59, 60, 61, 63, 64, 65, 66, 67, 68, 69, 70, 71}
	FOLLOW(<label>) = {0, 1, 2, 4, 5, 7, 8, 9, 10, 11, 13, 24, 44, 49, 50, 53, 54, 55, 56, 57, 58, 59, 60, 61, 63, 64, 65, 66, 67, 68, 69, 70, 71}
	FOLLOW(<declr>) = {$, 0, 1, 2, 4, 5, 7, 8, 9, 10, 11, 13, 24, 44, 49, 53, 54, 55, 56, 57, 58, 59, 60, 61, 63, 64, 65, 66, 67, 68, 69, 70, 71}
	FOLLOW(<var_declr>) = {$, 0, 1, 2, 4, 5, 7, 8, 9, 10, 11, 13, 24, 44, 49, 53, 54, 55, 56, 57, 58, 59, 60, 61, 63, 64, 65, 66, 67, 68, 69, 70, 71}
	FOLLOW(<assign>) = {9}
	FOLLOW(<for_init>) = {0, 1, 5, 9, 10, 11, 13, 24, 44, 65, 68, 69}
	FOLLOW(<for_exp>) = {6, 9}
	...
	FOLLOW(<arg_list>) = {6}
	FOLLOW(<arg>) = {6}
	FOLLOW(<unary_op>) = {0, 1, 5, 10, 11, 13, 24, 44, 65, 68, 69}
	FOLLOW(<binary_op>) = {0, 1, 5, 10, 11, 13, 24, 44, 65, 68, 69}
...
int first(int input_token, int nt_set){
    switch(nt_set){
        ...
        case NT_FOR_INIT:
            return (input_token == 0 || input_token == 1 || input_token == 2 || input_token == 5 || input_token == 9 || input_token == 10 || input_token == 11 || input_token == 13 || input_token == 24 || input_token == 44 || input_token == 63 || input_token == 64 || input_token == 65 || input_token == 66 || input_token == 67 || input_token == 68 || input_token == 69 || input_token == 70 || input_token == 71);
...
int follow(int input_token, int nt_set){
    switch(nt_set){
        ...
        case NT_SPECIFIER:
            return (input_token == 0 || input_token == 2 || input_token == 63 || input_token == 64 || input_token == 66 || input_token == 67 || input_token == 70 || input_token == 71);

        case NT_SPECIFIER_MULTI:
            return (input_token == 0);

        case NT_TYPE:
            return (input_token == 0 || input_token == 2 || input_token == 6 || input_token == 63 || input_token == 64 || input_token == 66 || input_token == 67 || input_token == 70 || input_token == 71);
        ...
        case NT_FOR_INIT:
            return (input_token == 0 || input_token == 1 || input_token == 5 || input_token == 9 || input_token == 10 || input_token == 11 || input_token == 13 || input_token == 24 || input_token == 44 || input_token == 65 || input_token == 68 || input_token == 69);
...
Node * p_nt_param_multi(Lexer_result lex_input){    // <param_multi> ::= "," <param_type_list> IDENT <param_multi> | ε
    if (nextSymbol.token_number == PN_COMMA) {
        ...
        Node * n = node_maker(x1, NULL, NT_PARAM_MULTI, 0);
...
Node * p_nt_func_content(Lexer_result lex_input){      // <func_content> ::= <block> | "PN_SEMI"
    if (first(nextSymbol.token_number, NT_BLOCK)) {
        ...
        Node * n = node_maker(x1, NULL, NT_FUNC_CONTENT, 0);
...
Node * p_nt_block(Lexer_result lex_input){      // <block> ::= "OPEN_BRACE" <instr_list> "CLOSE_BRACE"
    if (nextSymbol.token_number == OPEN_BRACE) {
        ...
        Node * n = node_maker(x1, NULL, NT_BLOCK, 0);
...
Node * p_nt_instr_list(Lexer_result lex_input){      // <instr_list> ::= <instr> <instr_list> | ε
    if (first(nextSymbol.token_number, NT_INSTR)) {
        ...
        Node * n = node_maker(x1, NULL, NT_INSTR_LIST, 0);
...
Node * p_nt_instr(Lexer_result lex_input){      // <instr> ::= <content> | <declr>
    if (first(nextSymbol.token_number, NT_CONTENT)) {
        ...
        Node * n = node_maker(x1, NULL, NT_INSTR, 0);
...
Node * p_nt_content(Lexer_result lex_input){    // <content> ::= "KW_RETURN" <exp> "PN_SEMI" | <exp> "PN_SEMI" | "PN_SEMI" | "KW_IF" "OPEN_PAREN" <exp> "CLOSE_PAREN" <content> <else> | "KW_GOTO" IDENT "PN_SEMI" | <label> | <block> | "KW_BREAK" "PN_SEMI" | "KW_CONTINUE" "PN_SEMI" | "KW_WHILE" "OPEN_PAREN" <exp> "CLOSE_PAREN" <content> | "KW_DO" <content> "KW_WHILE" "OPEN_PAREN" <exp> "CLOSE_PAREN" "PN_SEMI" | "KW_FOR" "OPEN_PAREN" <for_init> <for_exp> "PN_SEMI" <for_exp> "CLOSE_PAREN" <content> | "KW_SWITCH" "OPEN_PAREN" <exp> "CLOSE_PAREN" <content> | "KW_CASE" <exp> "OP_COLON" | "KW_DEFAULT" "OP_COLON"
    if (first(nextSymbol.token_number, NT_LABEL) && peek(lex_input, 1).token_number == OP_COLON) {
        ...
        Node * for_init_block = node_maker(x2, NULL, NT_BLOCK, 0);
...
Node * p_nt_else(Lexer_result lex_input){   // <else> ::= "KW_ELSE" <content> | ε
...
Node * p_nt_for_init(Lexer_result lex_input){   // <for_init> ::= <var_declr> | <exp> ";" | ";"
...
Node * p_nt_for_exp(Lexer_result lex_input){   // <for_exp> ::= <exp> | ε
    if (first(nextSymbol.token_number, NT_EXP)) {
        ...
        Node * n = node_maker(x1, NULL, NT_FOR_EXP, 0);
    ...
    if (nextSymbol.token_number == IDENT || nextSymbol.token_number == NUM_INT || nextSymbol.token_number == NUM_LONG || nextSymbol.token_number == NUM_UINT || nextSymbol.token_number == NUM_ULONG || nextSymbol.token_number == OPEN_PAREN || first(nextSymbol.token_number, NT_UNARY_OP)) {
        ...
        while (((first(nextSymbol.token_number, NT_BINARY_OP)) || nextSymbol.token_number == OP_QUESTION) && (priority_table[nextSymbol.token_number] >= min_priority)) {
            if (nextSymbol.token_number >= OP_ASSIGN && nextSymbol.token_number <= OP_ASREQ) {
                ...
                left->brother = operator;
                operator->brother = right;

                Node * new_left = node_maker(left, NULL, NT_EXP, 0);
                left = new_left;
                ...
                left->brother = op_question;
                op_question->brother = middle;
                middle->brother = op_colon;
                op_colon->brother = right;
...
Node * p_nt_arg(Lexer_result lex_input){   // <arg> ::= "PN_COMMA" <exp> <arg> | ε
    if (nextSymbol.token_number == PN_COMMA) {
        ...
        Node * n = node_maker(x1, NULL, NT_ARG, 0);
