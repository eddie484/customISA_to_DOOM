...
module GISA_CPU (clk, nRESET);
	...
	decode D (clk, nRESET, instr_D, pc_D, icode_D, load_D, dmen_D, dmrw_D, aluop_D, sign_D, mulsel_D, lk_D, valA_D, valB_D, wdata_D, dmsize_D, dmsext_D, setcc_D, cond_D, branch_D, rD_D, wben_D, jump_D, wben_W, rD_W, valD_W);
	...
	wire [5:0] icode_E;
	wire [3:0] aluop_E, cond_E, rD_E;
	wire [1:0] mulsel_E, dmsize_E;
	wire load_E, dmen_E, dmrw_E, sign_E, lk_E, dmsext_E, setcc_E, branch_E, wben_E, taken_E;
	...
	execute E (clk, nRESET, aluop_E, sign_E, mulsel_E, valA_E, valB_E, setcc_E, cond_E, branch_E, valE_E, taken_E);
	...
	wire [3:0] rD_M;
	wire [1:0] dmsize_M;
	wire load_M, dmen_M, dmrw_M, lk_M, dmsext_M, wben_M;
	...
	memory M (clk, nRESET, dmen_M, dmrw_M, valE_M, wdata_M, dmsize_M, dmsext_M, valM_M);
